...
export default function ClientsCarouselWhite() {
    ...
    <section className="py-20 lg:py-32 bg-gradient-to-b from-white via-gray-50 to-white relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <div className="relative bg-white backdrop-blur-sm rounded-3xl p-8 border border-gray-200 hover:border-publixy-gold/30 transition-all duration-500 shadow-xl hover:shadow-2xl">
            {/* Featured Client */}
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-publixy-gold font-bold text-lg">
              ...
              {/* ROI Badge */}
              <motion.div
                className="bg-gradient-to-r from-publixy-teal to-publixy-gold text-white px-6 py-3 rounded-2xl font-black text-xl shadow-lg"
                animate={{
                  boxShadow: [
                    '0 10px 30px rgba(123,211,226,0.3)',
                    '0 10px 40px rgba(239,189,74,0.4)',
                    '0 10px 30px rgba(123,211,226,0.3)',
                  ]
                }}
                transition={{
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center p-4 bg-gray-50 border border-gray-200 rounded-xl shadow-sm">
                <div className="text-2xl font-black text-publixy-teal mb-1">
                  {((activeClient * 23) % 60 + 50) / 10}M
                </div>
                <div className="text-sm text-gray-600 font-semibold">Impresiones</div>
              </div>
              <div className="text-center p-4 bg-gray-50 border border-gray-200 rounded-xl shadow-sm">
                <div className="text-2xl font-black text-publixy-gold mb-1">
                  {((activeClient * 17) % 30 + 25) / 10}%
                </div>
                <div className="text-sm text-gray-600 font-semibold">CTR</div>
              </div>
              <div className="text-center p-4 bg-gray-50 border border-gray-200 rounded-xl shadow-sm">
            ...
            >
              {duplicatedClients.map((client, index) => (
                <motion.div
                  ...
                  className={`flex-shrink-0 w-32 h-32 flex flex-col items-center justify-center rounded-2xl transition-all duration-500 cursor-pointer ${
                    index % clients.length === activeClient
                      ? 'bg-gradient-to-br from-publixy-gold/10 to-publixy-teal/10 border-2 border-publixy-gold/50 scale-110 shadow-lg'
                      : 'bg-white border border-gray-200 hover:bg-gray-50 hover:border-gray-300 shadow-sm hover:shadow-lg'
                  }`}
                ...
                >
                  ...
                  <div className="text-xs text-gray-900 font-bold text-center px-2">
                    {client.name}
                  </div>
        ...
        >
          {[...new Set(clients.map(c => c.category))].map((category) => (
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-6 py-3 bg-white backdrop-blur-sm border border-gray-200 rounded-full text-sm text-gray-700 hover:border-publixy-teal/50 hover:text-publixy-teal transition-all font-semibold shadow-sm hover:shadow-lg"
            >
              {category}
            </motion.button>
          ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mt-16">
          ...
          >
            ...
            <div className="text-gray-600 font-semibold">Marcas Activas</div>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="text-gray-600 font-semibold">Campañas Exitosas</div>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="text-gray-600 font-semibold">Años Experiencia</div>
          </motion.div>
        </div>
      </div>
    </section>
