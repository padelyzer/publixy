  ...
  return (
    ...
    >
      <div className="container mx-auto px-6">
        {/* OPCIÓN 1: Header Centrado Compacto */}
        <div className={`mx-auto max-w-4xl rounded-2xl transition-all duration-500 ${
          scrolled 
          ...
          <div className="flex items-center justify-center px-6 py-3">
            ...
            <motion.button
              ...
              className="ml-6 p-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-xl transition-all duration-300"
