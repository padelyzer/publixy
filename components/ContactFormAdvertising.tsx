...
export default function ContactFormAdvertising() {
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-4 text-publixy-gold">
              ...
              <span className="font-semibold">Procesando tu solicitud...</span>
            </div>
          </motion.div>
        </div>
      </section>
  ...
  return (
    <section className="py-20 lg:py-32 bg-gradient-to-b from-publixy-charcoal to-black relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Gradient Orbs */}
        <motion.div
          className="absolute top-20 right-20 w-80 h-80 bg-publixy-teal/10 rounded-full blur-3xl"
          animate={{
            x: [0, 100, 0],
            y: [0, -100, 0],
          }}
        ...
        />
        <motion.div
          className="absolute bottom-20 left-20 w-80 h-80 bg-publixy-gold/10 rounded-full blur-3xl"
          animate={{
            x: [0, -100, 0],
            y: [0, 100, 0],
          }}
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  >
                    ...
                    <div className="relative">
                      <input
                        ...
                        required
                        className="w-full px-6 py-4 bg-black/30 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:border-publixy-gold focus:outline-none focus:ring-2 focus:ring-publixy-gold/20 transition-all duration-300"
                      />
                      <AnimatePresence>
                  ...
                  >
                    ...
                    <div className="relative">
                      <select
                        ...
                        onBlur={() => setFocusedField(null)}
                        className="w-full px-6 py-4 bg-black/30 border border-white/20 rounded-xl text-white focus:border-publixy-gold focus:outline-none focus:ring-2 focus:ring-publixy-gold/20 transition-all duration-300 appearance-none"
                      >
                ...
                >
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      className="w-full px-6 py-4 bg-black/30 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:border-publixy-gold focus:outline-none focus:ring-2 focus:ring-publixy-gold/20 transition-all duration-300 resize-none"
                    />
                    <AnimatePresence>
                ...
                >
                  <motion.button
                    ...
                    className="relative px-12 py-5 bg-gradient-to-r from-publixy-gold to-publixy-yellow text-publixy-charcoal font-black text-lg rounded-full shadow-2xl hover:shadow-publixy-gold/25 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed min-w-[200px]"
                    ...
                    {isSubmitting ? (
                      <div className="flex items-center justify-center gap-3">
                        <motion.div
                          ...
                          className="w-5 h-5 border-2 border-publixy-charcoal border-t-transparent rounded-full"
                        />
                        Enviando...
                      </div>
                    ) : (
